<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upload_id.aspx.cs" Inherits="TVDisplay.upload_id" %>
                     ...
                     <div class="w3-container w3-cell-row w3-padding  w3-round-large w3-margin-top ct" style="height:75vh; background-color:#fff;">
                        <div class="w3-cell w3-cell-middle w3-margin-bottom">
                            ...
                            <div class="w3-row w3-padding w3-margin-bottom">
                                <asp:Button Text="Register"  OnClick="submit_click" ValidationGroup="login_submit" CssClass="w3-btn w3-text-white w3-large w3-padding w3-round-large" BackColor="#166D89" Width="100%" runat="server" />
